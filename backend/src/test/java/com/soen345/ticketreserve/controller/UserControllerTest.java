...
class UserControllerTest {
    ...
    void shouldRegisterUser() throws Exception {
        ...
        when(userService.registerUser(org.mockito.ArgumentMatchers.any())).thenReturn(user);
    ...
    void shouldLoginUser() throws Exception {
        ...
        when(userService.loginUser(org.mockito.ArgumentMatchers.any())).thenReturn(user);
